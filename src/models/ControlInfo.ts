...
const AlternativeTemperaturTargets: { [key: string]: 'M' } = {
  M: 'M',
};
...
export class ControlInfo {
  ...
  public static parseResponse(dict: ResponseDict, cb: DaikinResponseCb<ControlInfo>): void {
    ...
    result.targetTemperature = DaikinDataParser.resolveFloat(dict, 'stemp', AlternativeTemperaturTargets);
    ...
    result.targetTemperatureMode1 = DaikinDataParser.resolveFloat(dict, 'dt1', AlternativeTemperaturTargets);
    result.targetTemperatureMode2 = DaikinDataParser.resolveFloat(dict, 'dt2', AlternativeTemperaturTargets);
    result.targetTemperatureMode3 = DaikinDataParser.resolveFloat(dict, 'dt3', AlternativeTemperaturTargets);
    result.targetTemperatureMode4 = DaikinDataParser.resolveFloat(dict, 'dt4', AlternativeTemperaturTargets);
    result.targetTemperatureMode5 = DaikinDataParser.resolveFloat(dict, 'dt5', AlternativeTemperaturTargets);
    result.targetTemperatureMode7 = DaikinDataParser.resolveFloat(dict, 'dt7', AlternativeTemperaturTargets);
    ...
    result.targetTemperatureB = DaikinDataParser.resolveFloat(dict, 'b_stemp', AlternativeTemperaturTargets);
  ...
  public getRequestDict(): RequestDict {
    ...
    if (this.mode !== undefined) dict['mode'] = this.mode;
    ...
    if (this.targetHumidity !== undefined) dict['shum'] = this.targetHumidity;
